...
* First run `@hash/create-scatters/create_scatters.js`. This is a [shared behavior](../../behaviors/) \([Index](https://hash.ai/index/5e754c3e792e5d85f4cdb5c4/create-scatters)\) that, when added to an agent, will create all of the associated "scatter\_templates". It's called _scatter_ because it's scattering the child agents around the map.
